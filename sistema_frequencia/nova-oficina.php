          ...
          <div class="col-md-6 col-md-offset-4">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group col-sm-12">  
                    <input class="form-control" placeholder="Nome da Oficina">
                </div>
                <div class="form-group col-sm-12">  
                    <textarea  placeholder="Decrição da oficina" class="form-control" rows="3"></textarea>
                </div>
                <div class="form-group col-sm-12"> 
                    <select id="" class="form-control ">
                        <option>Locais onde irá ocorrer</option>
                    </select>
                </div>
